    ...
    public class CompanyDescriptionController : Controller
    {
        ...
        public ActionResult Index(Guid? Id)
        {
            ...
            else
            {
                ...
                var companyDescriptions = db.CompanyDescriptions.Where(c => c.Company == Id).Include(c => c.CompanyProfile).Include(c => c.SystemLanguageCode);
                return View(companyDescriptions.ToList());
            }
        }
        //public ActionResult Index(String Id)
        //{
        //    var companyDescriptions = db.CompanyDescriptions.Where(c => c.CompanyDescription == Id).Include(c => c.CompanyProfile).Include(c => c.SystemLanguageCode);
        //    return View(companyDescriptions.ToList());
        //}
